...
export default function CreateModerationForm() {
  ...
  return (
    <>
      ...
      <Select
        ...
        name="model"
        options={[
          { title: "omni-moderation-latest", value: "omni-moderation-latest" },
          {
            title: "omni-moderation-2024-09-26",
            value: "omni-moderation-2024-09-26",
          },
          { title: "text-moderation-latest", value: "text-moderation-latest" },
          { title: "text-moderation-stable", value: "text-moderation-stable" },
